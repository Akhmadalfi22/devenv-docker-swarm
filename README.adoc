...
|<<prometheus>> | http://{host}:9090 | link:docker-compose.prometheus.yml[] | Prometheus ({prometheus-version}) | PROMETHEUS_REPLICAS

|<<grafana>> | http://{host}:3000 +
http://{host}:3100 +
http://{host}:3200 | link:docker-compose.grafana.yml[] | 
